...
class UnidadMedidaDAO_postgre extends \app\common\dao\TSLAppBasicRecordDAO_postgre {
    ...
    /**@inheritdoc@see \TSLBasicRecordDAO::getAddRecordQuery()
     */
    protected function getAddRecordQuery(\TSLDataModel &$record, \TSLRequestConstraints &$constraints = NULL) : string {
        ...
        . 'unidad_medida_tipo,unidad_medida_default,unidad_medida_protected,activo,usuario) values(\'' .
                ...
                ($record->get_unidad_medida_protected() != TRUE ? '0' : '1'). '::boolean,\'' .
                $record->getActivo() . '\',\'' .
                $record->getUsuario() . '\')';
    }
    ...
    protected function getUpdateRecordQuery(\TSLDataModel &$record) : string {
        ...
        return 'update tb_unidad_medida set unidad_medida_codigo=\'' . $record->get_unidad_medida_codigo() . '\','.
                ...
                'unidad_medida_protected=\'' . ($record->get_unidad_medida_protected() != TRUE ? '0' : '1'). '\'::boolean,' .
